...
/**
 * SCA Authorization title description fields
 *
...
public class AuthorizationContent {
    ...
    public AuthorizationContent(@NotEmpty String confirmationCode, @NotEmpty String title, @NotEmpty String description) {

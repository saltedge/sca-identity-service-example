...
public class ScaNotificationsRequest {
    @JsonProperty(ScaSdkConstants.KEY_DATA)
    public List<ScaNotification> data;

    public ScaNotificationsRequest() {
    }

    public ScaNotificationsRequest(List<ScaNotification> data) {
        this.data = data;
    }
}

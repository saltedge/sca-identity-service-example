...
public class ScaConfigurationResponse {
    @JsonProperty(ScaSdkConstants.KEY_DATA)
    public ScaProviderConfigurationData data;

    public ScaConfigurationResponse() {
    }

    public ScaConfigurationResponse(ScaProviderConfigurationData data) {
        this.data = data;
    }
}

...
public class ScaUpdateAuthorizationRequest extends AuthenticatedRequestAbs {
    @JsonProperty(ScaSdkConstants.KEY_DATA)
    @NotNull
    @Valid
    public Data data;

    public ScaUpdateAuthorizationRequest() {
    }

    public ScaUpdateAuthorizationRequest(@NotNull Boolean confirm, @NotNull String authorizationCode) {

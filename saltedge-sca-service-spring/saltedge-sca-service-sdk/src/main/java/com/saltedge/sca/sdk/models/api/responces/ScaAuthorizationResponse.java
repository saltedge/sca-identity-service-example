...
public class ScaAuthorizationResponse {
    @JsonProperty(ScaSdkConstants.KEY_DATA)
    public ScaEncryptedEntity data;

    public ScaAuthorizationResponse() {
    }

    public ScaAuthorizationResponse(ScaEncryptedEntity data) {
        this.data = data;
    }
}

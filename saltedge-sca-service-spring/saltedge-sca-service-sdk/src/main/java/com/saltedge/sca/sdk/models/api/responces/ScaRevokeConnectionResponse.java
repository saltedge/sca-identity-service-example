...
public class ScaRevokeConnectionResponse {
    @JsonProperty(ScaSdkConstants.KEY_DATA)
    public Data data;

    public ScaRevokeConnectionResponse() {
    }

    public ScaRevokeConnectionResponse(Data data) {
        this.data = data;
    }

    public ScaRevokeConnectionResponse(Boolean success, String accessToken) {
